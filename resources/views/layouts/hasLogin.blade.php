    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">{{ config('app.name', 'Library') }}</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                            ...
                            <ul class="nav nav-treeview" style="display: none;">
                                <li class="nav-item">
                                    <a href="{{ url('transaction/create') }}"
                                        class="nav-link {{ request()->is('transaction/create') ? 'active' : '' }}">
                                        <i class="nav-icon fas fa-shopping-cart"></i>
                                        <p>Transaction</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('account') }}" class="nav-link {{ request()->is('user') ? 'active' : '' }}">
